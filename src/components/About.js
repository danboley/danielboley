  ...
  return (
    <div className="my-24">
      <div className="">
        ...
        <h2>Ultrarunner</h2>
        <p>
          One of my biggest passions is running. I love running on trails, up
          mountains, really anywhere. I've run the <a>NYC Marathon</a>, won a
          small <a>trail marathon</a>, and have run races up to <a>50 miles</a>.
