...
function Contact() {
  return (
      ...
      <div className="max-w-xl mx-auto h-auto flex flex-col justify-center">
        <div className="grid gap-8">
          <div className="sm:mx-36 p-6 shadow-xl rounded-xl shadow-gray-300 transition ease-in-out sm:hover:scale-110">
            <a href="https://www.linkedin.com/in/daniel-boley/"
                target="_blank">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
            <div className="flex items-center justify-center text-7xl">
              <div className="m-auto"><SiLinkedin /></div>
            </div>
          ...
          <div className="sm:mx-36 p-6 shadow-xl rounded-xl shadow-gray-300 transition ease-in-out sm:hover:scale-110">
            ...
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
            <div className="flex items-center justify-center text-7xl">
              <div className="m-auto"><MdOutlineEmail /></div>
            </div>
            <div className="flex flex-col items-center justify-center text-xl md:text-3xl">
                Email
            </div>
          ...
          <div className="sm:mx-36 p-6 shadow-xl rounded-xl shadow-gray-300 transition ease-in-out sm:hover:scale-110">
            ...
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
            <div className="flex items-center justify-center text-7xl">
              <div className="m-auto"><SiGithub /></div>
            </div>
            <div className="flex flex-col items-center justify-center text-xl md:text-3xl">
                GitHub
            </div>
    ...
    // <div className="my-24 w-full lg:h-screen bg-green-400">
    //   <div className="max-w-7xl m-auto bg-red-400">
    ...
    //     <div>
    //       <div className="flex flex-col transition ease-in-out sm:hover:scale-110 bg-purple-300">
    //         <div className="flex items-center justify-center text-7xl">
    //           <SiLinkedin />
    //         </div>
    //         <h2 className="flex items-center justify-center text-xl md:text-3xl">
    //           <a
    //             href="https://www.linkedin.com/in/daniel-boley/"
    //             target="_blank"
    //           >
    //             LinkedIn
    //           </a>
    ...
    //       <div className="flex flex-col transition ease-in-out sm:hover:scale-110">
    //         <div className="flex items-center justify-center text-7xl">
    //           <MdOutlineEmail />
    //         </div>
    //         <h2 className="flex items-center justify-center text-xl md:text-3xl">
