...
function Navbar() {
  return (
    <div className="bg-black text-white fixed top-0 left-0 right-0 w-full h-20 flex justify-between items-center p-4 sm:p-6 font-bold">
        <Link to="/">
        ...
        <div className="space-x-2 flex items-center md:space-x-4">
          ...
          <Link className="focus:text-gray-300" to="/about">
            <h2 className="text-xl md:text-3xl transition ease-in-out hover:scale-110">About</h2>
            </Link>
          <Link className="focus:text-gray-300" to="/techprojects">
            <h2 className="text-xl md:text-3xl transition ease-in-out hover:scale-110">Projects</h2>
          </Link>
          <Link className="focus:text-gray-300" to="/skills">
          <h2 className="text-xl md:text-3xl transition ease-in-out hover:scale-110">Skills</h2>
          </Link>
          <Link className="focus:text-gray-300" to="/contact">
          <h2 className="text-xl md:text-3xl transition ease-in-out hover:scale-110">Contact</h2>
          </Link>
        </div>
    </div>
  )
